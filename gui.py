...
class ConstraintsView(GtkSource.View):
    def __init__(self):
        ...
        tempfilehandle = open(tempdirname+"/candl.lang", "w")
        tempfilehandle.write("""<?xml version="1.0" encoding="UTF-8"?>
<language id="candl" _name="LLVM IR" version="2.0" _section="Source">
  <metadata>
...
""")
        ...
        self.code = open(BINARY_DIRECTORY+"llvm/lib/CAnDLParser/IdiomSpecification.txt").read()
        self.get_buffer().set_language(language_manager.get_language("candl"))
        self.get_buffer().set_highlight_syntax(True)
        self.modify_font(Pango.FontDescription("Monospace 10"))
        self.set_show_line_numbers(True)

        os.remove(tempdirname+"/candl.lang")
